...
packages <- c("knitr", "kableExtra", "DT", "table1", "reticulate", "gapminder",
              "latex2exp", "tidyverse", "plotly", "maps", "sf", "tmap", 
              "rio", "readxl", "DiagrammeR")
...
# Inicializar renv solo si no ha sido inicializado previamente
if (!dir.exists("renv")) {
  renv::init()
}
