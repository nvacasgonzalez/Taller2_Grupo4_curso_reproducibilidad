...
shapefile_path <- "C:/Users/natal/OneDrive - Universidad Alberto Hurtado/PERSONAL/DIPLOMADO DATA SCIENCE/M. REPRODUCIBILIDAD/Taller_n2/Taller2_Grupo4_curso_reproducibilidad/docs/Regiones"  
regiones_sf <- st_read(shapefile_path)


# Unir la tabla de beneficiarios con el shapefile usando la columna "region"
mapa_beneficiarios <- regiones_sf %>%
  left_join(beneficiarios_por_region, by = "Region")  

tmap_options(check.and.fix = TRUE)

# Creación  de mapa de calor con tmap
