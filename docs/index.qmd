...
El presente proyectos se rige bajo el modelo ETL (Extract, Transform, Load) para el proceso de integración y gestión de datos, particularmente en la creación de Data Warehouses o sistema de análisis de datos. A continuación desglosaremos cada una de las etapas que lo componen:
...
Las **bases de datos** a explorar consisten en:

![Bases de datos utilizadas en el proyecto](fig/BBDD_extracción.png){width="50%"}
