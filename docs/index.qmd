...
[^1]: Se considerarán beneficiarios potenciales a aquellas personas provadas de libertad con condena dictada y recluidas en un régimen de 24h.

<!-- -->

-   N° y porcentaje de beneciarios efectivos (equivale a la matrícula de centros educativos en contexto de encierro) [^2]

[^2]: Se considerarán beneficiarios efectivos al n° total de personas matriculadas por centro educativo en contexto de encierro
