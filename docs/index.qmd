...
#La función: renv::init() fue ejecutada en la consola

# No obstante, prevalecen problemas en la sincronización de renv y renv.lock por lo que se introduce el siguiente código: 
